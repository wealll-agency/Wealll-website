        ...
        >
          {partners.map((partner, index) => (
            <SwiperSlide key={index}>
              <div
                className="partner-card w-100 h-100 d-flex align-items-center justify-content-center rounded"
                style={{
                  minHeight: '100px',
...
export default LandingTechPartners;
